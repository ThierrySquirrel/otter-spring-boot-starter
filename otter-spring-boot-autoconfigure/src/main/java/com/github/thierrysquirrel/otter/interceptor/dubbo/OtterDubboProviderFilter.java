...
/**
 * ClassName: OtterDubboProviderFilter
 * Description:
 * date: 2020/1/3 16:08
 *
...
public class OtterDubboProviderFilter implements Filter {
	...
	public Result invoke(Invoker<?> invoker, Invocation invocation) {
		Optional<Object> globalId = Optional.ofNullable(RpcContext.getContext().getAttachment(InterceptorConstant.INTERCEPTOR_IDENTIFIER.getValue()));
